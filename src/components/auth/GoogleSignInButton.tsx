  ...
  return (
    <div className="flex flex-col gap-2">
      <button
        ...
        onClick={handleClick}
        disabled={loading}
        className="inline-flex w-full items-center justify-center gap-3 rounded-full border border-[#E5E3DA] bg-white px-5 py-3 text-[14px] font-medium text-neutral-900 transition-colors hover:bg-[#FAFAF8] disabled:cursor-not-allowed disabled:opacity-60 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-700"
      >
        <GoogleGMark />
